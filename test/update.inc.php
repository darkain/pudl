...
pudlTest($db, "UPDATE `table` SET `column`='value' WHERE `id`=1");
...
pudlTest($db, "UPDATE `table` SET `column`='value' WHERE `id`='value'");
...
pudlTest($db, "UPDATE `table` SET `column`=1 WHERE `id`='value'");
...
pudlTest($db, "UPDATE `table` SET `column`=1.1 WHERE `id`='value'");
...
pudlTest($db, "UPDATE `table` SET `column`=NULL WHERE `id`='value'");
...
pudlTest($db, "UPDATE `table` SET `column1`='value' WHERE `column2`=3");
...
pudlTest($db, "UPDATE `table` SET `column1`='value' WHERE `id`=5");
...
pudlTest($db, "UPDATE `table` SET `column`=`column`+2.3 WHERE `id`=1");
...
pudlTest($db, "UPDATE `table` SET `column`='value' WHERE (`id` IN ('1', '7', '7', '9'))");
...
pudlTest($db, "UPDATE `table` SET `column`='value' WHERE (`id` IN (NULL, NULL, NULL, NULL))");
...
pudlTest($db, "UPDATE `table` SET `column`=CONCAT_WS(',', `column`, 'item') WHERE `id`=1");
...
pudlTest($db, "UPDATE `table` SET `column`=TRIM(BOTH ',' FROM REPLACE(CONCAT(',', `column`, ','), ',item,', ',')) WHERE `id`=1");
...
pudlTest($db, "UPDATE `parent` SET `column1`=(SELECT COUNT(*) FROM `child` WHERE `column2`='value' LIMIT 1) WHERE `column2`='value'");
...
pudlTest($db, "UPDATE `table` SET `column`=JSON_SET(IFNULL(NULLIF(TRIM(`column`), ''), '{}'),'$.param',JSON_COMPACT('[\\\"one\\\",\\\"two\\\",\\\"three\\\"]')) WHERE 1");
...
pudlTest($db, "UPDATE `table` SET `column`=NULL WHERE 1");
