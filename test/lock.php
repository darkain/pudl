...
pudlTest('LOCK TABLES `table1` AS `t1` WRITE, `table2` AS `t2` WRITE, `table3` AS `t3` WRITE');
...
pudlTest('LOCK TABLES `table1` AS `t1` READ, `table2` AS `t2` READ');
...
pudlTest('LOCK TABLES `table1` AS `t1` WRITE, `table2` AS `t2` WRITE');
...
pudlTest('LOCK TABLES `r-table1` AS `r1` READ, `r-table2` AS `r2` READ, `r-table3` READ, `w-table4` WRITE, `w-table5` AS `w5` WRITE, `w-table6` AS `w6` WRITE, `x-table7` WRITE, `x-table8` AS `x8` WRITE, `x-table9` WRITE');
